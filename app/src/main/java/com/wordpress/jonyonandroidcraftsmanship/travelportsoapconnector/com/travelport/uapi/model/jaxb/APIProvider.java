 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.travelport.com/schema/common_v28_0}TransactionType" minOccurs="0"/>
 ...
 *       &lt;attribute name="SupplierCode" type="{http://www.travelport.com/schema/common_v28_0}typeSupplierCode" />
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
public class APIProvider {
    ...
    @XmlElement(name = "AvailablePseudoCityCode", required = true)
    protected List<AvailablePseudoCityCode> availablePseudoCityCode;
     ...
     * {@link AvailablePseudoCityCode }
     * 
     * 
     */
    public List<AvailablePseudoCityCode> getAvailablePseudoCityCode() {
        if (availablePseudoCityCode == null) {
            availablePseudoCityCode = new ArrayList<AvailablePseudoCityCode>();
        }
