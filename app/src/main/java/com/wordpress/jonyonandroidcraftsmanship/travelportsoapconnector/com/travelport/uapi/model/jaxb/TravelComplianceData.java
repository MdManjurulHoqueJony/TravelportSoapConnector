 ...
 *                 &lt;attribute name="PolicyToken" type="{http://www.travelport.com/schema/common_v28_0}StringLength1to128" />
 *               &lt;/restriction>
 *             &lt;/complexContent>
 *           &lt;/complexType>
 *         &lt;/element>
 ...
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;attribute name="ContractToken" type="{http://www.travelport.com/schema/common_v28_0}StringLength1to128" />
 ...
 *                 &lt;attribute name="ProfileType" use="required" type="{http://www.travelport.com/schema/common_v28_0}typeProfileType" />
 *               &lt;/restriction>
 *             &lt;/complexContent>
 *           &lt;/complexType>
 *         &lt;/element>
 ...
 *       &lt;attribute name="RailSegmentRef" type="{http://www.travelport.com/schema/common_v28_0}typeRef" />
 *       &lt;attribute name="ReservationLocatorRef" type="{http://www.travelport.com/schema/common_v28_0}typeLocatorCode" />
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
public class TravelComplianceData {
    ...
    @XmlElement(name = "PolicyCompliance", required = true)
    protected List<PolicyCompliance> policyCompliance;
    @XmlElement(name = "ContractCompliance", required = true)
    protected List<ContractCompliance> contractCompliance;
    @XmlElement(name = "PreferredSupplier", required = true)
    protected List<PreferredSupplier> preferredSupplier;
     ...
     * {@link PolicyCompliance }
     * 
     * 
     */
    public List<PolicyCompliance> getPolicyCompliance() {
        if (policyCompliance == null) {
            policyCompliance = new ArrayList<PolicyCompliance>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ContractCompliance }
     * 
     * 
     */
    public List<ContractCompliance> getContractCompliance() {
        if (contractCompliance == null) {
            contractCompliance = new ArrayList<ContractCompliance>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PreferredSupplier }
     * 
     * 
     */
    public List<PreferredSupplier> getPreferredSupplier() {
        if (preferredSupplier == null) {
            preferredSupplier = new ArrayList<PreferredSupplier>();
        }
